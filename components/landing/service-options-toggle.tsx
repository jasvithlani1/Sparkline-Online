    ...
    case "story-voice":
      return (
        <svg viewBox="0 0 48 48" aria-hidden="true" className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7">
          ...
          />
          <path d="M15 17H33M15 23H29" fill="none" stroke="currentColor" strokeWidth="3.2" strokeLinecap="round" />
        </svg>
      );
    case "design":
      return (
        <svg viewBox="0 0 48 48" aria-hidden="true" className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7">
          ...
          <rect x="25" y="23" width="16" height="16" rx="2.8" fill="none" stroke="currentColor" strokeWidth="3.2" />
        </svg>
      );
    case "development":
      return (
        ...
        {serviceOptions.map((option) => (
          ...
          >
            ...
            >
              ...
              <p
                className="mt-2.5 max-w-[26ch] text-[11px] leading-[1.2] tracking-[-0.03em] text-white sm:text-[13px] md:mt-3 md:max-w-[28ch] md:text-[14px]"
              >
                {option.description}
              </p>
            </Link>
