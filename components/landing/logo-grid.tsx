      ...
      <div className="mx-auto flex max-w-[1208px] flex-col items-center gap-12 sm:gap-14 md:gap-16">
        ...
        <div data-testid="trusted-by-marquee" className="relative w-full overflow-hidden py-2">
          <div
            ...
            className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-[linear-gradient(90deg,#FDFCF4,rgba(253,252,244,0))] sm:w-20 md:w-28"
          />
          <div
            data-testid="trusted-by-marquee-right-mask"
            className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-[linear-gradient(270deg,#FDFCF4,rgba(253,252,244,0))] sm:w-20 md:w-28"
          />
