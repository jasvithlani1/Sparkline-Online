    ...
    <section id="services" className="bg-[#FDFCF4] px-5 py-8 sm:px-6 sm:py-10 md:px-8 md:py-14">
      <div className="relative mx-auto max-w-[1310px]">
        ...
        <div
          ...
          className="pointer-events-none relative ml-auto mr-[calc((100vw-100%)/-2)] -mt-[4.5rem] h-[128px] w-full max-w-[300px] sm:-mt-[5.75rem] sm:h-[188px] sm:max-w-[420px] md:-mt-[12rem] md:h-[316px] md:max-w-[560px] lg:-mt-[15.5rem] lg:h-[367px] lg:max-w-[650px]"
        >
          <Image
            src="/images/service-submarine.webp"
            alt=""
            fill
            sizes="(min-width: 1280px) 650px, (min-width: 768px) 560px, (min-width: 640px) 420px, 300px"
